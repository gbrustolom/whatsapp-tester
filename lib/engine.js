...
const observerCallback = async function (mutationsList) {
    ...
    for (let mutation of mutationsList) {
        ...
        if (mutation.type === 'childList') {
            ...
            if (mutation.addedNodes.length > 0 && mutation.addedNodes[0].role === 'row' && checkVisibility(document.querySelector(VISIBILITY_TARGET), mutation.addedNodes[0])) {
...
function checkVisibility(container, item) {
